...
DisplayModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, material_1.MaterialModule],
        declarations: [display_component_1.DisplayComponent],
        exports: [display_component_1.DisplayComponent],
    })
], DisplayModule);
